...
export interface ITemplateAppQueryClient {
  moduleId: string;
  accountQueryClient: AbstractAccountQueryClient;
  _moduleAddress: string | undefined;
  config: () => Promise<ConfigResponse>;
  connectSigningClient: (signingClient: SigningCosmWasmClient, address: string) => TemplateAppClient;
  address: () => Promise<string>;
}
export class TemplateAppQueryClient implements ITemplateAppQueryClient {
  accountQueryClient: AbstractAccountQueryClient;
  moduleId: string;
  _moduleAddress: string | undefined;
...
export interface ITemplateAppClient extends ITemplateAppQueryClient {
  accountClient: AbstractAccountClient;
  updateConfig: (fee?: number | StdFee | "auto", memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
}
export class TemplateAppClient extends TemplateAppQueryClient implements ITemplateAppClient {
  accountClient: AbstractAccountClient;
