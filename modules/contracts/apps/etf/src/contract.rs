...
use crate::{
    error::EtfError,
    handlers::{self, instantiate::INSTANTIATE_REPLY_ID},
    msg::{EtfExecuteMsg, EtfInstantiateMsg, EtfQueryMsg, MyUntaggedMsg},
    ETF_APP_ID,
};
...
pub type EtfApp =
    AppContract<EtfError, EtfInstantiateMsg, EtfExecuteMsg, EtfQueryMsg, Empty, MyUntaggedMsg>;
