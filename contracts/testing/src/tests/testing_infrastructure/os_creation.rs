...
use crate::tests::testing_infrastructure::upload::upload_contracts;
...
fn init_os(app: &mut TerraApp, sender: Addr, native_contracts: &NativeContracts, os_store : HashMap<u32, Core>) -> OsInstance {
    let _resp = app
        .execute_contract(
            sender.clone(),
