...
use pandora_os::modules::add_ons::subscription::msg::InstantiateMsg as SubInitMsg;
...
pub fn init_primary_os(
    ...
    let init_msg = to_binary(&SubInitMsg {
        ...
        subscription: pandora_os::modules::add_ons::subscription::msg::SubscriptionInstantiateMsg {
    ...
    let msg = pandora_os::core::manager::msg::ExecuteMsg::CreateModule {
