...
use crate::modules::dapp_base::msg::{BaseQueryMsg, BaseStateResponse};
use crate::modules::dapp_base::state::BASESTATE;
...
pub fn try_query_config(deps: Deps) -> StdResult<BaseStateResponse> {
    ...
    Ok(BaseStateResponse {
        proxy_address: state.proxy_address.into_string(),
