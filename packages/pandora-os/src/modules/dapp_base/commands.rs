...
use crate::modules::dapp_base::state::{ADMIN, BASESTATE};
...
pub fn handle_base_message(
    ...
    match message {
        BaseExecuteMsg::UpdateConfig { proxy_address } => update_config(deps, info, proxy_address),
...
/// Updates traders or proxy address
