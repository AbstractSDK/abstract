use cosmwasm_std::{
    to_binary, Addr, BankMsg, Coin, CosmosMsg, Decimal, Fraction, StdResult, WasmMsg,
};
use cw20::Cw20ExecuteMsg;
use cw_asset::{Asset, AssetInfo};

// pub fn deduct_tax(deps: Deps<TerraQueryWrapper>, coin: Coin) -> StdResult<Coin> {
...
// pub fn compute_tax(deps: Deps<TerraQueryWrapper>, coin: &Coin) -> StdResult<Uint128> {
