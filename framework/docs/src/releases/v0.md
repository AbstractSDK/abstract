...
- `update_natives_in_version_control` added to the `abstract_interface::Abstract` for registering new versions of native contracts in Version Control
...
- IBC client and host now deployed instead of migration on version change
