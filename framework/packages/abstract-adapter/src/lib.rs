...
pub mod mock {
    ...
    ($name:ident, $id:expr, $version:expr, $deps:expr) => {
        ...
        use ::abstract_adapter::mock::{MockExecMsg, MockQueryMsg, MockUntaggedMsg, MockInitMsg, MockAdapterContract, MockError};
        ...
        type Exec = $crate::std::adapter::ExecuteMsg<MockExecMsg, MockUntaggedMsg>;
    ...
    ($name:ident, $id:expr, $version:expr, $deps:expr) => {
        ...
        fn execute(
            ...
            env: ::cosmwasm_std::Env,
            info: ::cosmwasm_std::MessageInfo,
            msg: $crate::std::base::ExecuteMsg<$crate::std::adapter::AdapterBaseMsg, MockExecMsg, MockUntaggedMsg>,
        ) -> Result<::cosmwasm_std::Response, <::abstract_adapter::mock::MockAdapterContract as ::abstract_sdk::base::Handler>::Error> {
            use ::abstract_sdk::base::ExecuteEndpoint;
        ...
        type Exec = $crate::std::base::ExecuteMsg<$crate::std::adapter::AdapterBaseMsg, MockExecMsg, MockUntaggedMsg>;
        type Query = $crate::std::adapter::QueryMsg<MockQueryMsg>;
        type Init = $crate::std::adapter::InstantiateMsg<MockInitMsg>;
        #[cw_orch::interface(Init, Exec, Query, Empty)]
        pub struct $name ;
