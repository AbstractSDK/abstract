    ...
    ($app_const:expr, $app_type:ty, $interface_name: ident) => {
        mod _wrapper_fns {
            ...
            pub fn instantiate(
                ...
                <$app_type as ::abstract_app::sdk::base::Handler>::Error,
            > {
            ...
            pub type InstantiateMsg =
                <$app_type as ::abstract_app::sdk::base::InstantiateEndpoint>::InstantiateMsg;
            pub type ExecuteMsg =
                <$app_type as ::abstract_app::sdk::base::ExecuteEndpoint>::ExecuteMsg;
            pub type QueryMsg = <$app_type as ::abstract_app::sdk::base::QueryEndpoint>::QueryMsg;
            pub type MigrateMsg =
                <$app_type as ::abstract_app::sdk::base::MigrateEndpoint>::MigrateMsg;
        }
