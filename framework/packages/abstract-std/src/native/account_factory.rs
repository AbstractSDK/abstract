...
pub enum ExecuteMsg {
    ...
    CreateAccount {
        ...
        ///
        /// When [`AccountTrace::Local`] when sequence in 0..2147483648 range:: Signals the expected Account Id. The tx will error if this does not match the account-id at runtime. Useful for instantiate2 address prediction. \
