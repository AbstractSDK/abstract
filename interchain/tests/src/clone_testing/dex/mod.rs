...
use abstract_app::objects::pool_id::PoolAddressBase;
use abstract_app::objects::PoolMetadata;
...
use abstract_interface::{Abstract, ExecuteMsgFns, VCExecFns};
    ...
    pub fn new(abstr_deployment: AbstractClient<Chain>, dex: Dex) -> anyhow::Result<Self> {
        ...
        let _ = abstr_deployment
            ...
            .remove_module(ModuleInfo::from_id(
                DEX_ADAPTER_ID,
                ModuleVersion::Version(abstract_dex_adapter::contract::CONTRACT_VERSION.to_owned()),
            )?);
